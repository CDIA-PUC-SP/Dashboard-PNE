...
if selected == "Plano Nacional de Educação":
    ...
    st.header(
        "O Plano Nacional de Educação (PNE) é uma Lei Federal nº 13.005/2014 com vigência decenal, que foi implementada no governo Dilma. São 20 metas (quantificáveis) que terão vigência entre 2014 até 2024, através de estratégias e ações. Está de acordo com o artigo 214 da constituição, as quais seguem as diretrizes:"
    )
