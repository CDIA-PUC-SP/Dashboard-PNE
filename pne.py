...
if selected == "Objetivo do projeto":
    ...
    st.write("**[Link de acesso>](https://simec.mec.gov.br/pde/relatorioMonitoramento.php)**")
    st.write("---")
    st.image(image2, width=1080)
    st.write("**[Link de acesso>](https://pne.mec.gov.br/18-planos-subnacionais-de-educacao/38-situacao-das-metas-dos-planos-de-)**")
