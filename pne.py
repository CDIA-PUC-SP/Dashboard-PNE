...
with st.sidebar:
    selected = option_menu(
        ...
        options=["Objetivo do projeto", "Plano Nacional de Educação", "Dados Abertos", "Divisão das funções", "Evolução do Projeto"],
        menu_icon="cast",
        default_index=0
    )
...
if selected == "Evolução do Projeto":
    ...
    st.write("Problema: Problema: Mostra uma taxa de 0 a 10, mas não apresenta como foram levantadas as variáveis")
    st.write("---")
